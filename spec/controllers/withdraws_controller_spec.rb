...
RSpec.describe WithdrawsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: withdraw.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      withdraw = Withdraw.create! valid_attributes
      get :edit, params: {id: withdraw.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Withdraw" do
        expect {
          post :create, params: {withdraw: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {withdraw: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested withdraw" do
        withdraw = Withdraw.create! valid_attributes
        put :update, params: {id: withdraw.to_param, withdraw: new_attributes}, session: valid_session
        withdraw.reload
      ...
      it "redirects to the withdraw" do
        withdraw = Withdraw.create! valid_attributes
        put :update, params: {id: withdraw.to_param, withdraw: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        withdraw = Withdraw.create! valid_attributes
        put :update, params: {id: withdraw.to_param, withdraw: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested withdraw" do
      withdraw = Withdraw.create! valid_attributes
      expect {
        delete :destroy, params: {id: withdraw.to_param}, session: valid_session
      }.to change(Withdraw, :count).by(-1)
    end
